...
class StrategieState(BaseModel):
    ...
    semantic_gaps: list[dict] = Field(default_factory=list)  # ST12 — gap semantique vs SERP
    source_scores: list[dict] = Field(default_factory=list)  # ST13 — GEO source scores
